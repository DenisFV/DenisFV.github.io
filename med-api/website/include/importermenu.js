...
// {
// 	var logoDiv = $('<div class="dropdown-menu" id="left">').attr ('id', 'logo').html (title).appendTo (this.buttonsDiv);
...
{
	var buttonImage;
	if(title==="Меню") buttonImage = $('<img class="knop">').addClass ('topbutton').attr ('src', image).attr ('title', title).appendTo (this.buttonsDiv);
	else buttonImage = $('<img style="text-align: center;">').addClass ('topbutton').attr ('src', image).attr ('title', title).appendTo (this.buttonsDiv);
