...
JSM.ConvertBodyToThreeMeshes = function (a, b, e) {
    var d = {textureLoadedCallback: null, hasConvexPolygons: !1};
    ...
    var c = [], g = null, f = null;
    JSM.ExplodeBody(a, b, {
        hasConvexPolygons: d.hasConvexPolygons, onPointGeometryStart: function (a) {
            f = new THREE.PointsMaterial({color: a.diffuse, size: a.pointSize});
        ...
        onPointGeometryEnd: function () {
            ...
            g = new THREE.Geometry;
            f = new THREE.LineBasicMaterial({color: a.diffuse})
            ...
            var b = null !== a.texture, e = 1 !== a.opacity, c =
                a.diffuse, G = a.specular, t = a.shininess;
            0 === t && (G = 0, t = 1);
            f = new THREE.MeshPhongMaterial({color: c, specular: G, shininess: t});
...
JSM.ConvertModelToThreeMeshes = function (a, b) {
    var e = [], d = a.GetMaterialSet(), c, g, f;
...
JSM.ConvertJSONDataToThreeMeshes = function (a, b, e) {
    function d(a, e, c, d) {
        function g(a, c, d, f, k, n) {
            ...
            var h = k[p];
            k = h.texture;
            var u = h.offset, v = h.scale, w = h.rotation, x = new THREE.Color, s = new THREE.Color,
                y = h.shininess || 0;
            ...
            var h = new THREE.Geometry, q, A, B, r, C, D, E, t, l;
            for (l = 0; l < a.length; l += 9) q = 3 * a[l + 0], A = 3 * a[l + 1], B = 3 * a[l + 2], r = 3 * a[l + 3], C = 3 * a[l + 4], D = 3 * a[l + 5], x = 2 * a[l + 6], s = 2 * a[l + 7], y = 2 * a[l + 8], E = h.vertices.length, t = h.faces.length, h.vertices.push(new THREE.Vector3(c[q + 0], c[q + 1], c[q + 2])), h.vertices.push(new THREE.Vector3(c[A + 0], c[A + 1], c[A + 2])), h.vertices.push(new THREE.Vector3(c[B + 0], c[B + 1], c[B + 2])), h.faces.push(new THREE.Face3(E + 0, E + 1, E + 2)), q =
                [], q.push(new THREE.Vector3(d[r + 0], d[r + 1], d[r + 2])), q.push(new THREE.Vector3(d[C + 0], d[C + 1], d[C + 2])), q.push(new THREE.Vector3(d[D + 0], d[D + 1], d[D + 2])), h.faces[t].vertexNormals = q, void 0 !== k && null !== k && (r = [], r.push(m(f[x + 0], f[x + 1], u, v, w)), r.push(m(f[s + 0], f[s + 1], u, v, w)), r.push(m(f[y + 0], f[y + 1], u, v, w)), h.faceVertexUvs[0].push(r));
...
JSM.ThreeViewer.prototype.GetMesh = function (a) {
    var b = null, e = 0, d;
    for (d = 0; d < this.scene.children.length; d++) if (b = this.scene.children[d], this.IsRelevantObject(b)) {
        if (e == a) return b;
        e += 1
    }
    return null
...
JSM.ThreeViewer.prototype.GetFilteredBoundingBox = function (a) {
    var b = new JSM.Coord(JSM.Inf, JSM.Inf, JSM.Inf), e = new JSM.Coord(-JSM.Inf, -JSM.Inf, -JSM.Inf), d, c;
...
JSM.ThreeViewer.prototype.GetFilteredBoundingSphere = function (a) {
    var b = this.GetFilteredCenter(a), e = 0, d, c, g;
...
JSM.ThreeViewer.prototype.ProjectVector = function (a, b, e) {
    var d = this.canvas.width / 2, c = this.canvas.height / 2;
